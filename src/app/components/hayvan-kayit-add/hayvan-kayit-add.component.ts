...
hayvanKayitAddForm:FormGroup;
  constructor(private formBuilder:FormBuilder, private hayvanKayitService:HayvanKayitService, private toastrService:ToastrService) { }
...
add(){
  if(this.hayvanKayitAddForm.valid){
    ...
    this.hayvanKayitService.add(hayvanKayitModel).subscribe(response=>{
