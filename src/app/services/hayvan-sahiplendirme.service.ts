...
export class HayvanSahiplendirmeService {
  ...
  getHayvanSahiplendirmes():Observable<ListResponseModel<HayvanSahiplendirme>>{
  ...
  add(hayvanSahiplendirme:HayvanSahiplendirme):Observable<ResponseModel>{
    return this.httpClient.post<ResponseModel>(this.apiUrl+"hayvanSahiplendirme/add",hayvanSahiplendirme)
  }
}
